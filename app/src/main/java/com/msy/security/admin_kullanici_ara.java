...
public class admin_kullanici_ara extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    //**************************************
    ...
    private static String path = "Kullanıcılar";

    private Button admin_list_geridönme;

    private Button tcarabtn;
    private EditText tcaratxt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_admin_kullanici_ara);
        //******************************************************************************************************************************
        ...
        listView = (ListView) findViewById(R.id.listview_kullanıcı_ara);

        tcarabtn = (Button) findViewById(R.id.ara_tc_btn);
        tcaratxt = (EditText) findViewById(R.id.ara_tc_edttxt);

        tcaratxt.setFilters(new InputFilter[] {new InputFilter.AllCaps()});


        tcarabtn.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        admin_list_geridönme.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!path.equals("Kullanıcılar")) {
                    ...
                    Intent adminsayfasına = new Intent(admin_kullanici_ara.this, admin_main.class);
    ...
    private void verial() {
        path = path + "/" + tcaratxt.getText().toString();
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.menu_giriscikis:
                Intent giriscikissayfasina = new Intent(admin_kullanici_ara.this, giriscikis.class);
                startActivity(giriscikissayfasina);
                finish();
                break;

            case R.id.menu_barkod:
                Intent barkodsayfasına = new Intent(admin_kullanici_ara.this, MainActivity.class);
                startActivity(barkodsayfasına);
                finish();
                break;
            case R.id.menu_yardım_ic:
                Intent icyardımsayfasına = new Intent(admin_kullanici_ara.this,yardimekrani_ic.class);
                startActivity(icyardımsayfasına);
                finish();
                break;
            case R.id.menu_sorun:
                Intent sorunbildirsayfasına = new Intent(admin_kullanici_ara.this,sorunbildir.class);
                startActivity(sorunbildirsayfasına);
                finish();
                break;
            case R.id.menu_kisiselbilgiler:
                Intent kisiselbilgilersayfasına = new Intent(admin_kullanici_ara.this,kisisel_bilgiler.class);
                startActivity(kisiselbilgilersayfasına);
                finish();
                break;
            case R.id.menu_kisiselraporlar:
                Intent kisiseraporlarsayfasına = new Intent(admin_kullanici_ara.this,kisisel_rapor.class);
